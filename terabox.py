...
ADMINS = list(map(int, os.environ.get('ADMINS', '6771203027').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://teraboxonline:pcJC3oCP4wEubdsF@cluster0.iqsuq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/ErrorFlo")
        developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/ErrorFloo")
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/TeraBoxLink2Video_bot?start=verify_{token}')
            ...
            tutorial_button = InlineKeyboardButton("How to Verify 🎥", url="https://t.me/ErrorFlo/66")
